...
def _evaluate_bbq(args: argparse.Namespace, mod: ModuleType) -> None:
    ...
    model_name = f"{args.model}_debias_nlg_baseline" if args.eval_baseline else f"{args.model}_debias_nlg_{args.model_tag}"
...
def _apply_defaults(args: argparse.Namespace) -> None:
    defaults: Dict[str, Dict[str, object]] = {
        "bbq": {
            ...
            "batch_size": 8,
            "model_dir": "/scratch/craj/diy/outputs/3_baselines/debias_nlg/models_bbq",
            "model_tag": "bbq_all",
            "output_file": "/scratch/craj/diy/results/3_baselines/debias_nlg/bbq_eval_llama_8b_debias_nlg.csv",
            "preds_output_file": "/scratch/craj/diy/outputs/3_baselines/debias_nlg/bbq_preds_llama_8b_debias_nlg.csv",
        },
        "crowspairs": {
            "model": "llama_8b",
            "data_path": "/scratch/craj/diy/data/crows_pairs_anonymized.csv",
            "batch_size": 4,
            "model_dir": "/scratch/craj/diy/outputs/3_baselines/debias_nlg/models_crowspairs",
            "model_tag": "crowspairs_all",
            "output_file": "/scratch/craj/diy/results/3_baselines/debias_nlg/crowspairs_metrics_overall_llama_8b_debias_nlg.csv",
            "per_bias_output_file": "/scratch/craj/diy/results/3_baselines/debias_nlg/crowspairs_metrics_by_bias_llama_8b_debias_nlg.csv",
            "pairs_output_file": "/scratch/craj/diy/outputs/3_baselines/debias_nlg/crowspairs_scored_llama_8b_debias_nlg.csv",
        },
        "stereoset": {
            "model": "llama_8b",
            ...
            "split": "all",
            "batch_size": 4,
            "model_dir": "/scratch/craj/diy/outputs/3_baselines/debias_nlg/models_stereoset",
            "model_tag": "stereoset_all",
            "results_json": "/scratch/craj/diy/results/3_baselines/debias_nlg/stereoset_eval_llama_8b_debias_nlg.json",
            "results_csv": "/scratch/craj/diy/results/3_baselines/debias_nlg/stereoset_eval_llama_8b_debias_nlg.csv",
            "predictions_file": "/scratch/craj/diy/outputs/3_baselines/debias_nlg/stereoset_predictions_llama_8b_debias_nlg.json",
            "scores_output_file": "/scratch/craj/diy/outputs/3_baselines/debias_nlg/stereoset_sentence_scores_llama_8b_debias_nlg.csv",
        },
    }
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="debias_NLG-inspired evaluation across BBQ/CrowS-Pairs/StereoSet")
