...
def _evaluate_bbq(args: argparse.Namespace, mod: ModuleType) -> None:
    ...
    adapter_path = None if args.eval_baseline else os.path.join(args.model_dir, f"model_{args.model_tag}")
    ...
    model_name = f"{args.model}_debias_llms_baseline" if args.eval_baseline else f"{args.model}_debias_llms_{args.model_tag}"
...
def _evaluate_stereoset(args: argparse.Namespace, mod: ModuleType) -> None:
    ...
    records_df, results, preds_json = mod.evaluate_examples(examples, model, tokenizer, batch_size=args.batch_size)
    model_name = f"{args.model}_debias_llms_baseline" if args.eval_baseline else f"{args.model}_debias_llms_{args.model_tag}"
...
def _apply_defaults(args: argparse.Namespace) -> None:
    defaults: Dict[str, Dict[str, object]] = {
        "bbq": {
            ...
            "batch_size": 8,
            "model_dir": "/scratch/craj/diy/outputs/3_baselines/debias_llms/models_bbq",
            "model_tag": "bbq_all",
            "output_file": "/scratch/craj/diy/results/3_baselines/debias_llms/bbq_eval_llama_8b_debias_llms.csv",
            "preds_output_file": "/scratch/craj/diy/outputs/3_baselines/debias_llms/bbq_preds_llama_8b_debias_llms.csv",
        },
        "crowspairs": {
            "model": "llama_8b",
            "data_path": "/scratch/craj/diy/data/crows_pairs_anonymized.csv",
            "batch_size": 4,
            "model_dir": "/scratch/craj/diy/outputs/3_baselines/debias_llms/models_crowspairs",
            "model_tag": "crowspairs_all",
            "output_file": "/scratch/craj/diy/results/3_baselines/debias_llms/crowspairs_metrics_overall_llama_8b_debias_llms.csv",
            "per_bias_output_file": "/scratch/craj/diy/results/3_baselines/debias_llms/crowspairs_metrics_by_bias_llama_8b_debias_llms.csv",
            "pairs_output_file": "/scratch/craj/diy/outputs/3_baselines/debias_llms/crowspairs_scored_llama_8b_debias_llms.csv",
        },
        "stereoset": {
            "model": "llama_8b",
            ...
            "split": "all",
            "batch_size": 4,
            "model_dir": "/scratch/craj/diy/outputs/3_baselines/debias_llms/models_stereoset",
            "model_tag": "stereoset_all",
            "results_json": "/scratch/craj/diy/results/3_baselines/debias_llms/stereoset_eval_llama_8b_debias_llms.json",
            "results_csv": "/scratch/craj/diy/results/3_baselines/debias_llms/stereoset_eval_llama_8b_debias_llms.csv",
            "predictions_file": "/scratch/craj/diy/outputs/3_baselines/debias_llms/stereoset_predictions_llama_8b_debias_llms.json",
            "scores_output_file": "/scratch/craj/diy/outputs/3_baselines/debias_llms/stereoset_sentence_scores_llama_8b_debias_llms.csv",
        },
    }
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Debias-LLMs-inspired evaluation across BBQ/CrowS-Pairs/StereoSet")
