...
def _evaluate_bbq(args: argparse.Namespace, mod: ModuleType) -> None:
    ...
    model_name = f"{args.model}_mbias_baseline" if args.eval_baseline else f"{args.model}_mbias_{args.model_tag}"
...
def _apply_defaults(args: argparse.Namespace) -> None:
    defaults: Dict[str, Dict[str, object]] = {
        "bbq": {
            ...
            "batch_size": 8,
            "model_dir": "/scratch/craj/diy/outputs/3_baselines/mbias/models_bbq",
            "model_tag": "bbq_all",
            "output_file": "/scratch/craj/diy/results/3_baselines/mbias/bbq_eval_llama_8b_mbias.csv",
            "preds_output_file": "/scratch/craj/diy/outputs/3_baselines/mbias/bbq_preds_llama_8b_mbias.csv",
        },
        "crowspairs": {
            "model": "llama_8b",
            "data_path": "/scratch/craj/diy/data/crows_pairs_anonymized.csv",
            "batch_size": 4,
            "model_dir": "/scratch/craj/diy/outputs/3_baselines/mbias/models_crowspairs",
            "model_tag": "crowspairs_all",
            "output_file": "/scratch/craj/diy/results/3_baselines/mbias/crowspairs_metrics_overall_llama_8b_mbias.csv",
            "per_bias_output_file": "/scratch/craj/diy/results/3_baselines/mbias/crowspairs_metrics_by_bias_llama_8b_mbias.csv",
            "pairs_output_file": "/scratch/craj/diy/outputs/3_baselines/mbias/crowspairs_scored_llama_8b_mbias.csv",
        },
        "stereoset": {
            "model": "llama_8b",
            ...
            "split": "all",
            "batch_size": 4,
            "model_dir": "/scratch/craj/diy/outputs/3_baselines/mbias/models_stereoset",
            "model_tag": "stereoset_all",
            "results_json": "/scratch/craj/diy/results/3_baselines/mbias/stereoset_eval_llama_8b_mbias.json",
            "results_csv": "/scratch/craj/diy/results/3_baselines/mbias/stereoset_eval_llama_8b_mbias.csv",
            "predictions_file": "/scratch/craj/diy/outputs/3_baselines/mbias/stereoset_predictions_llama_8b_mbias.json",
            "scores_output_file": "/scratch/craj/diy/outputs/3_baselines/mbias/stereoset_sentence_scores_llama_8b_mbias.csv",
        },
    }
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="MBIAS-inspired evaluation across BBQ/CrowS-Pairs/StereoSet")
