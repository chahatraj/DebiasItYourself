...
EXPECTED_METHODS = [
    ...
    ("reduce_social_bias", "Reduce Social Bias", "baseline"),
    ("selfdebias_reprompting", "SelfDebias Reprompting", "baseline"),
]
...
def legend_handles_for_rows(rows: list[dict[str, object | str]]) -> list[Patch]:
    handles: list[Patch] = []
    for group in ["diy_show", "diy_teach", "diy_teach_show", "diy_revise", "diy_teach_revise", "baseline"]:
