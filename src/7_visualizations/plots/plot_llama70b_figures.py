...
def read_m4_bbq_strategy_mean_source(
    ...
    if method_key == "icl_1":
        paths = [
            ICL_ONE_ROOT / f"bbq/bbq_metrics_m4_baseicl_one_llama70b_{tag}_bbq.csv"
            for tag in M4_STRATEGY_TAGS
        ]
    elif method_key == "ft_icl_1":
        paths = [
            FT_ICL_ONE_ROOT / f"bbq/bbq_metrics_m4_fticl_one_llama70b_{tag}_bbq.csv"
            for tag in M4_STRATEGY_TAGS
        ]
    else:
        return None
        ...
        for method in SHOT_METHODS:
            ...
            if key == "base":
                ...
                if row:
                    ...
                    records.append(row)
                    continue
                path = icl_bias_path(dataset_key, shot=1)
